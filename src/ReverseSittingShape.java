 ...
 * checking for the reverse sitting shape.
 * 
 * @author Christopher Murray
 * @version 1.0 (April 2014)
 */
public class ReverseSittingShape extends Shape {

	/**
	 * Sets the initial position of the reverse sitting shape.
	 */
	...
	/**
	 * Second rotation state, which for the reverseSitting shape is it's initial
	 * position
	 */
	...
	private boolean checkRotationOne(int[][] grid) {
		if ((grid[shapeX[0]][shapeY[0] + 2] >= 2 && grid[shapeX[0]][shapeY[0] + 2] <=8)
